...
use crate::{instance::VulkanInstance, MaterialPipelineInfo};
...
///
/// Crates multiple Pipelines from the same Vertex & Fragment Shaders with diffrent Settings from `MaterialPipelineInfo`
///
pub fn create_from_materials(
    instance: &VulkanInstance,
    vertex_file: String,
    ...
    attrib_desc: &[vk::VertexInputAttributeDescription],
    surface_resolution: vk::Extent2D,
    materials: &[MaterialPipelineInfo],
) -> Vec<vk::Pipeline> {
    let vertex_code =
